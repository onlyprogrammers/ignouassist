              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4 group">
                    ...
                    <div>
                      <h4 className="font-semibold text-xl mb-2 group-hover:text-yellow-300 transition-colors">
                        {feature.title}
                      </h4>
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      ...
                      <div className="text-3xl font-bold text-yellow-300 mb-1">{stat.value}</div>
            ...
            {[
              {
                ...
                rating: 5,
                comment:
                  "IGNOU Hub transformed my academic journey! Their assignments helped me score 85% consistently. The support team is incredible!",
              },
              {
                name: "Priya Sharma",
                program: "MBA Student",
              ...
              },
              {
                ...
                rating: 5,
                comment:
                  "Affordable pricing, excellent quality, and amazing support. The synopsis help was invaluable for my project work!",
              },
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button
                size="lg"
                variant="outline"
                className="text-lg px-8 py-4 text-white border-white/50 hover:bg-white/10 hover:border-white transform hover:scale-105 transition-all duration-300"
              >
